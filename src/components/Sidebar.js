...
const Sidebar = () => {
  ...
  return (
    <div className="d-flex justify-content-between g-0 row">
      <div className="bg-white p-2 m-0 vh-100 shadow col col-2">
        ...
        <div className="list-group list-group-flush">
          ...
          <p className="mt-3 ms-1 fs-6 fw-bold">
      ...
      <div className="overflow-auto vh-100 col-10" style={{ flexGrow: 1 }}>
        <Outlet />
      </div>
    </div>
  );
